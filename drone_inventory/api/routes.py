...
@token_required
def createDrone(current_user_token):
    ...
    cost_of_production,series,user_token = user_token)
...
def update_drone(current_user_token,id):
    ...
    drone.cam_quality = request.json['camera_quality']
    ...
    drone.cost_of_prod = request.json['cost_of_production']
