...
class Drone(db.Model):
    ...
    def __init__(self, name, description, price, camera_quality,
     flight_time, max_speed, dimensions, weight, cost_of_production, series, user_token, id=""):
        self.id = self.set_id()
        self.name = name
    ...
    def __repr__(self):
        return f"The following Drone has been created:"
